...
################################################################################
## Form generated from reading UI file 'GUIAUcwiC.ui'
##
...
"font: 75 10pt \"MS Shell Dlg 2\";")
        ...
        self.pantalla.setCurrentIndex(2)
    ...
    def retranslateUi(self, Form):
        ...
        self.pantalla.setTabText(self.pantalla.indexOf(self.todos_los_productos), QCoreApplication.translate("Form", u"VER PRODUCTOS", None))
        ...
        self.bt_agregar.setText(QCoreApplication.translate("Form", u"AGREGAR TODO EL PRODUCTO", None))
        self.l_agregar_producto_nuevo.setText(QCoreApplication.translate("Form", u"AGREGAR UN NUEVO PRODUCTO", None))
        self.pantalla.setTabText(self.pantalla.indexOf(self.add_producto), QCoreApplication.translate("Form", u"AGREGAR NUEVO PRODUCTO", None))
        ...
        self.pantalla.setTabText(self.pantalla.indexOf(self.mod_producto), QCoreApplication.translate("Form", u"ACTUALIZAR PRODUCTO", None))
        ...
        self.pantalla.setTabText(self.pantalla.indexOf(self.borrar_producto), QCoreApplication.translate("Form", u"BORRAR PRODUCTO", None))
    # retranslateUi
